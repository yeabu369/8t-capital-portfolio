...
3. Install `@upstash/analytics` in your product
...
This product uses `pnpm` for dependency management.
...
```
- `TABLE` is a namespace to group events together. ie for managing multiple products int a single database
