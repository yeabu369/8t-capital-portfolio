...
date: "2021-03-16"
repository: 8tcapital/terraform-provider-vercel
url: https://registry.terraform.io/providers/8tcapital/vercel/latest
published: true
---
...
I needed to manage my Vercel products and especially sync environment variables from different cloud providers.
...
terraform {
  required_providers {
    vercel = {
      source  = "registry.terraform.io/8tcapital/vercel"
      version = ">=0.10.3"
    }
  }
}
...
resource "vercel_project" "my_project" {
  name = "product-via-terraform"
  git_repository {
    type = "github"
    repo = "8tcapital/terraform-provider-vercel"
  }
}
```

It was a fun product and I learned a lot about Terraform and Vercel's API. 
...
Now that Vercel have stepped in, I have decided to [deprecate](https://twitter.com/8tcapital_/status/1517759708983177218) this one on April 23rd 2022. 
